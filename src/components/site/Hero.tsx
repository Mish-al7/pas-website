...
export function Hero() {
  ...
  return (
    <section id="object" ref={ref} className="relative overflow-hidden grain">
      {/* Glow */}
      ...
      <div className="flex flex-col md:hidden">
        {/* Text block */}
        <div className="relative z-10 px-6 pt-32 pb-10">
          <motion.p
          ...
          <div className="mt-8 text-right">
            <h1 className="font-display display-tight text-[15vw] font-light leading-none">
              You,
              <br />
            ...
            >
              Connect the wearable you already own. PAS AI listens to your biometrics in the
              background, learns your personal baseline, and speaks only when something meaningful
              drifts.
            </motion.p>
          </div>
        </div>
        ...
        >
          <img
            ...
            width={1536}
            height={1536}
            className="w-[85vw] max-w-sm object-contain drop-shadow-[0_40px_80px_rgba(0,0,0,0.7)]"
          />
        </motion.div>
        ...
        <motion.div
          ...
          className="flex items-center justify-between px-6 pb-12 text-[11px] font-mono uppercase tracking-[0.2em] text-muted-foreground"
        >
      ...
      <div className="relative hidden min-h-[110vh] md:block">
        {/* Phone — absolute */}
        <motion.div
        ...
        {/* Copy overlay */}
        <div className="relative z-10 mx-auto flex min-h-screen max-w-[1600px] flex-col justify-between px-10 pb-20 pt-48">
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.4 }}
          ...
          <div className="self-end text-right md:max-w-2xl">
            <h1 className="font-display display-tight text-[8vw] font-light leading-none">
              You,
              <br />
              <span className="italic">
                {word.map((c, i) => (
